...
def display_test(skill):
    ...
    if questions_list:
        ...
        if st.button("Submit Test"):
            ...
            st.markdown(f"""
            ### Recommended Courses
            1. [Introduction to {skill}](https://example.com/course/1) - A beginner-friendly course on {skill}.
            2. [Advanced {skill} Techniques](https://example.com/course/2) - For those looking to deepen their knowledge.
            3. [Mastering {skill}](https://example.com/course/3) - An in-depth course for advanced learners.
            
            ### Recommended Job Roles
            1. [Junior {skill} Specialist](https://example.com/job/1) - Entry-level role focusing on core {skill} tasks.
            2. [Senior {skill} Analyst](https://example.com/job/2) - For experienced professionals with a strong background in {skill}.
            3. [Lead {skill} Engineer](https://example.com/job/3) - A leadership role involving strategic {skill} initiatives.
            """)
